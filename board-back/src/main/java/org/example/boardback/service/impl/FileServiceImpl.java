...
public class FileServiceImpl {
    ...
    /** 실제 업로드 경로 생성 */
    private String buildPullPath(String relative, String storedName) {
        return basePath + "/" + relative + "/" + storedName;
    }
    ...
    public FileInfo saveUserProfile(MultipartFile file) {
        ...
        try {
            ...
            throw new FileStorageException("프로필 업로드 실패");
        }
    }
    ...
    public FileInfo saveBoardFile(Long boardId, MultipartFile file) {
        ...
        try {
            ...
            throw new FileStorageException("게시글 파일 업로드 실패");
        }
    }
