...
export const BOARD_PATH = {
  //? cf) Sping Boot의 controller는 class 파일 단위의 Mapping값 설정 가능
  ...
  LIKE_CANNEL: (boardId: number) => `${BOARD_PREFIX}/${boardId}/like/cancel`,
  ...
  DRAFT_BY_IB: (draftId: number) => `${BOARD_PREFIX}/draft/${draftId}`,
